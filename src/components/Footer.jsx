const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.988-5.367 11.988-11.988C24.005 5.367 18.638.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.229 14.97 3.76 13.814 3.76 12.517s.469-2.452 1.366-3.274c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.897.822 1.366 1.977 1.366 3.274s-.469 2.452-1.366 3.274c-.875.807-2.026 1.297-3.323 1.297zm7.108 0c-1.297 0-2.448-.49-3.323-1.297-.897-.822-1.366-1.977-1.366-3.274s.469-2.452 1.366-3.274c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.897.822 1.366 1.977 1.366 3.274s-.469 2.452-1.366 3.274c-.875.807-2.026 1.297-3.323 1.297z" clipRule="evenodd" />
        </svg>
      )
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering young people to turn their skills into earning opportunities through safe, 
              legitimate digital platforms and comprehensive training.
            </p>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="max-w-md">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Get the latest opportunities, tips, and success stories delivered to your inbox.
              </p>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-gray-400 text-sm">
              © {currentYear} Skill2Cash. All rights reserved.
            </div>
            <div className="mt-4 md:mt-0">
